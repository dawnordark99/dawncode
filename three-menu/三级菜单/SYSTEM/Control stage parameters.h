...
//
#define BusVolt_CHANNEL                 ADC_Channel_8
#define BusVolt_GPIO_PORT   			      GPIOB
#define BusVolt_GPIO_PIN     		        GPIO_Pin_0
...
#define SLEEP_GPIO_PIN             				GPIO_Pin_11
